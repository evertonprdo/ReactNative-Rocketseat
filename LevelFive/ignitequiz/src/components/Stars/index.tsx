...
import Animated, { BounceIn, Easing, useSharedValue, withRepeat, withTiming } from "react-native-reanimated";
...
export function Stars() {
    const backStarsBlinkAnimated = useSharedValue(0);
    const frontStarsBlinkAnimated = useSharedValue(0);

    useEffect(() => {
        backStarsBlinkAnimated.value = withRepeat(
            withTiming(1, { duration: 2000, easing: Easing.ease }),
            -1,
            true
        );
        frontStarsBlinkAnimated.value = withRepeat(
            withTiming(1, { duration: 3000, easing: Easing.bounce }),
            -1,
            true
        );
    }, []);
